...
class UsersRepositoryImpl implements UsersRepository {
  ...
  UsersRepositoryImpl({required UsersRemoteDatasource remote, required NetworkInfo network})
  ...
  @override Future<Either<Failure, List<UserEntity>>> getUsers() => _run(_remote.getUsers);
  @override Future<Either<Failure, UserEntity>> getUser(int id) => _run(() => _remote.getUser(id));
  @override Future<Either<Failure, bool>> blockUser(int id) => _run(() => _remote.blockUser(id));
}
